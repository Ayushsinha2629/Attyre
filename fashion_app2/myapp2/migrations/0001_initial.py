    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('store', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='products', to='myapp2.store')),
                ('variants', models.ManyToManyField(related_name='products', to='myapp2.variant')),
            ],
        ),
        migrations.CreateModel(
            name='Video',
            fields=[
                ...
                ('music', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='videos', to='myapp2.music')),
                ('products', models.ManyToManyField(blank=True, related_name='videos', to='myapp2.product')),
